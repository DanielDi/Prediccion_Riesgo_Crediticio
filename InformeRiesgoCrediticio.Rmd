...
Similarmente, se ilustran las personas con estado Defualt agrupadas por el puntaje obtenido:
...
+ PrediCrédito cumple de forma eficiente y satisfactoria sus funciones, logrando predecir de forma rápida y optima el ScoreCard de cada persona de acuerdo a su comportamiento financiero, además de compararlo globalmente con los prestatarios registrados de nuestra base de datos y obteniendo su percentil inmediato de acuerdo al puntaje obtenido, todo esto utilizando como preguntas las variables de riesgo más importantes para la predicción del mismo.
