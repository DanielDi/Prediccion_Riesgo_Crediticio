...
gg2 <- ggplot( train_woes, aes( prediction,color = as.factor(good_bad) )) + 
geom_density( size = 1 ) +
ggtitle( "Predicciones para el Conjunto de Validación" ) + 
scale_color_economist( name = "Datos", labels = c( "Negativo", "Positivo" ) ) + 
theme_economist()
...
Con base a esta tabla se puede determinar un AUC de `r metrics$binomial_metric$dat[,"AUC"]` y el cutoff óptimo es de 0.11. Con base a este valor de corte es que se convierten las probabilidades en etiquetas 1 o 0.
